        ...
        <div>
            <div className="media">
                <div className="media-body title">
                    <h2 className="mt-0 mb-1 words">DZK Electronic Voting System</h2><br/><br/>
                    <div className="row words">
                        <img className="blue-icon" src={blue} alt={""}/>
                        <h1 className="words">Decentralized</h1>
                        <br/>
                    </div>

                    <div className="row words">
                        <img className="red-icon" src={red} alt={""}/>
                        <h1 className="words">Secure</h1>
                        <br/>
                    </div>

                    <div className="row words">
                        <img className="green-icon" src={green} alt={""}/>
                        <h1 className="words">Trustworthy</h1>
                        <br/>
                    </div>
                </div>
                <img className="banner rouned float-right ml-3" src={banner} alt={""}/>
            </div>
            ...
            <div className="row justify-content-md-center text-center">
                ...
                <div className="col col-lg-2 options options-right icons">
                    <Link to="/Vote">
                        <img src={Vote} alt={""}/><br/>
